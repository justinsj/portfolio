...
export const awards: Project[] = [
  {
    ...
    dimensions: [300, 400],
    screenshots: [
      'https://firebasestorage.googleapis.com/v0/b/portfolio-90f8d.appspot.com/o/awards%2FIMG_3225.JPG.jpg?alt=media&token=e0382cda-aae7-46fc-afd9-c1a39f7509c7'
    ],
    stack: [],
    repository: '',
    deployment: {},
  ...
  },
  {
    ...
    dimensions: [278, 400],
    screenshots: [
      'https://firebasestorage.googleapis.com/v0/b/portfolio-90f8d.appspot.com/o/awards%2Frepulse%20bay.jpg?alt=media&token=4543c407-7c88-4fb2-b46d-c90aa95befeb'
    ],
    stack: [],
    repository: '',
    deployment: {},
